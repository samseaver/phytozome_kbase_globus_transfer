...
root="Phytozome_Feb2022"
version="V13"
f=open(root+'/Accepted_Phytozome_Versions_GeneModels.txt')
...
for species in sorted(Accepted_Paths.keys()):
    for number in sorted(Accepted_Paths[species].keys()):
        for type in ("annotation","assembly","ontology","synonyms","functions"):
